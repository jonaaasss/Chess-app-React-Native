...
/**
 * Chess piece artwork: the "cburnett" SVG piece set by Colin M.L. Burnett,
 * used by default on Lichess and Wikipedia. Licensed CC BY-SA 3.0:
 * https://commons.wikimedia.org/wiki/Category:SVG_chess_pieces_by_Cburnett
 * Path data fetched verbatim from Wikimedia Commons and reproduced here
 * under that license. viewBox is the original 0-45 coordinate system.
 */
export function PieceArt({ code }: { code: PieceCode }) {
  switch (code) {
    case 'wK':
      return (
    ...
    case 'bK':
      return (
        <G fill="none" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
          <Path d="M22.5 11.63 22.5 6" strokeLinejoin="miter" />
          <Path
            d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5"
            fill="#000"
            strokeLinecap="butt"
          ...
          <Path
            d="M32 29.5s8.5-4 6.03-9.65C34.15 14 25 18 22.5 24.5l0 2.1 0-2.1C20 18 10.85 14 6.97 19.85 4.5 25.5 13 29.5 13 29.5"
            fill="none"
            stroke="#fff"
          />
          <Path d="M12.5 30c5.5-3 14.5-3 20 0M12.5 33.5c5.5-3 14.5-3 20 0M12.5 37c5.5-3 14.5-3 20 0" fill="none" stroke="#fff" />
        </G>
      );
    case 'wQ':
      return (
        <G fill="#fff" stroke="#000" strokeWidth={1.5} strokeLinejoin="round">
          <Path d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5-7.5 11.5-.3-14.1-5.2 14-3-14-3 14-5.2-14-.3 14.1L6.5 13.5 9 26z" />
    ...
    case 'bQ':
      return (
        <G fill="#000" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
          <Path
            d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5-7.5 11.5-.3-14.1-5.2 14-3-14-3 14-5.2-14-.3 14.1L6.5 13.5 9 26z"
            strokeLinecap="butt"
          />
          <Path d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1 2.5-1 2.5-1.5 1.5 0 2.5 0 2.5 6.5 1 16.5 1 23 0 0 0 1.5-1 0-2.5 0 0 .5-1.5-1-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z" />
    ...
    case 'wN':
      return (
        <G fill="none" stroke="#000" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
          ...
          <Path
            d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.04-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4.003 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.994-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-1.992 2.5-3c1 0 1 3 1 3"
            fill="#fff"
            stroke="#000"
          />
          <Circle cx={9} cy={25.5} r={0.5} fill="#000" stroke="#000" />
          <Path
            d="M14.5 15.5a0.5 1.5 0 1 1-1 0 0.5 1.5 0 1 1 1 0z"
